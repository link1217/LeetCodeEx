...
---------------------
### **5. [Longest Palindromic Substring](https://github.com/lanrengufeng/LeetCodeEx/blob/master/src/leetcode/LongestPalindromicSubstring.java)** Levle: Medium	Tags: String, Dynamic Programming
- 暴力拓展，遍历每一个字符，以此字符为中心向两边拓展，求最大回文长度
- 马拉车算法：求字符串中的最大回文子串长度

------------------------------
### **6. [ZigZag Conversion](https://github.com/lanrengufeng/LeetCodeEx/blob/master/src/leetcode/ZigZagConversion.java)** Level: Medium		Tags: String 
...
--------------------------------------
### **8. [String to Integer (atoi)](https://github.com/lanrengufeng/LeetCodeEx/blob/master/src/leetcode/StringToInteger.java)** Level: Medium		Tags: Math, String
...
---------------------------
### **11. [Container With Most Water](https://github.com/lanrengufeng/LeetCodeEx/blob/master/src/leetcode/ContainerWithMostWater.java)** Level： Medium   Tags： Array, Two Pointers 
...
----------------------
### **140. [Word Break II](https://github.com/lanrengufeng/LeetCodeEx/blob/master/src/leetcode/WordBreakII.java)**	Level: Hard		Tags:Dynamic Programming, BackTracking 
- 深度优先搜索：
>	参考代码理解
...
-----------------------------
### **867. [Transpose Matrix](https://github.com/lanrengufeng/LeetCodeEx/blob/master/src/leetcode/TransposeMatrix.java)**	Level:Easy	Tags: Array
- 二维数组的转置，ij互换即可
